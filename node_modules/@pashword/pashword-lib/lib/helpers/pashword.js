...
const _debug = (0, debug_1.debug)('pashword');
...
const sanitize = (pashword, no_symbols, no_numbers) => {
...
const generatePashword = async (to_hash, pashword_length, website, username) => {
